...
cls
	...
	echo Internet Connection Found! Proceeding...
		...
		@powershell -NoProfile -ExecutionPolicy Bypass -Command "choco install -y --force --allow-empty-checksums adobereader partitionwizard simplenote bitwarden virtualbox sublimetext3 brave chromium firefox vlc youtube-dl gimp 7zip discord twitch tukui teamviewer winrar vnc-viewer vnc-connect open-shell jpegview vcredist-all directx onlyoffice lenovo-thinkvantage-system-update"
